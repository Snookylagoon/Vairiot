...
export function DepreciationPage() {
  ...
  const columns: DataTableColumn<DepRow>[] = [
    ...
    {
      key: 'monthlyDepreciation', label: 'Monthly',
      render: r => <span className="font-mono">{fmtCurrency(r.monthlyDepreciation)}</span>,
      className: 'px-4 py-3 text-right', headerClassName: 'px-4 py-3 text-right',
    },
    {
      key: 'accumulatedDepreciation', label: 'Accum.',
      render: r => <span className="font-mono text-red-600">{fmtCurrency(r.accumulatedDepreciation)}</span>,
      className: 'px-4 py-3 text-right', headerClassName: 'px-4 py-3 text-right',
    },
    {
