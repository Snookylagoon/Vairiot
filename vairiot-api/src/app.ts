...
import { identificationRouter } from './routes/gs1/identification.router';
import { identifiersRouter }  from './routes/gs1/identifiers.router';
import { labelsRouter }       from './routes/gs1/labels.router';
import { tagsRouter }         from './routes/gs1/tags.router';
...
export function createApp(): Application {
  ...
  gated.use('/identification', identificationRouter);
  gated.use('/identifiers',  identifiersRouter);
  gated.use('/tags',         tagsRouter);
  gated.use('/labels',       labelsRouter);
